...
Keep any local notebook input outside the repository unless it has passed the same public-data review described in [`../../docs/public_data.md`](../../docs/public_data.md).
