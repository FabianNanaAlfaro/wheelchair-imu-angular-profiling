...
% Notes
% -----
% - This is a general study/support script. The public manuscript figures
%   are generated by scripts/generate_manuscript_figures.py.
...
% One local variable definition drives extraction, summaries, and labels.
variableSpec = {
    'Hombro_FE',  'Shoulder FE';
    'Hombro_Abd', 'Shoulder AA';
    'Codo_FE',    'Elbow FE';
    'Muneca_FE',  'Wrist FE';
    'Muneca_UD',  'Wrist RUD'};
angleVars = variableSpec(:,1)';
displayLabels = variableSpec(:,2)';
prettyNames = containers.Map(angleVars, displayLabels);
...
boxplot(boxData, 'Labels', displayLabels);
ylabel('Device-defined angular excursion (deg)');
...
set(gca, 'XTick', 1:numel(angleVars), 'XTickLabel', displayLabels, ...
         'YTick', 1:numel(angleVars), 'YTickLabel', displayLabels, ...
