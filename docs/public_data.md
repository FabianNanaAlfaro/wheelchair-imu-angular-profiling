...
| `assets/manuscript/` | Publication-ready Figures 5–6 generated from the manuscript excursion table. | Visual outputs only; no additional participant-level source data. |
